...
function App() {
  const { currentPath, setCurrentPath, navigateTo, setLoading, setError, setFiles, loading, setHomeDir, toggleHiddenFiles, toggleFoldersFirst, directoryPreferences, globalPreferences, loadPinnedDirectories } = useAppStore()
  ...
  useEffect(() => {
    ...
    initializeApp()
  }, [setCurrentPath, navigateTo, setLoading, setError, setFiles, setHomeDir, loadPinnedDirectories])
