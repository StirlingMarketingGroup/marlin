...
export default function ZoomSlider({ visible }: ZoomSliderProps) {
  const { currentPath, globalPreferences, directoryPreferences, updateDirectoryPreferences, showZoomSliderNow, scheduleHideZoomSlider } = useAppStore()
  ...
  return (
    ...
    <div className="fixed top-16 right-3 z-50 select-none" data-tauri-drag-region={false}
